/**
 * i18n.js - Translation engine for MoneyClever
...
const I18n = (() => {
  ...
  async function init() {
    _lang = localStorage.getItem('mc-lang') || 'en';
  ...
  function getStrategyName(strategy) {
    if (strategy.name[_lang]) return strategy.name[_lang];
    return strategy.name.en || strategy.id;
  }
  ...
  async function setLang(lang) {
    ...
    _applyTranslations();
    _updateSwitcher();
    document.dispatchEvent(new CustomEvent('mc-lang-change', { detail: { lang: _lang } }));
  }
  ...
  return { init, t, getLang, getManifest, getStrategyName, setLang };
})();
